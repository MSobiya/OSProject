...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String JSON_URL = "http://192.168.0.103/Android_OS_Project/mysql_connect_retrieve.php";
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length() ; i++) {
                        ...
                        String slab_no = String.valueOf(json_data.getInt("lab_no"));
                    ...
                    Toast.makeText(getApplicationContext(), "No PC ON", Toast.LENGTH_SHORT).show();
                }
